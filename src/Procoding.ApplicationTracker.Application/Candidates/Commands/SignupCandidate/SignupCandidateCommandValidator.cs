...
public sealed class SignupCandidateCommandValidator : AbstractValidator<SignupCandidateCommand>
{
    public SignupCandidateCommandValidator(ICandidateRepository candidateRepository)
    {
